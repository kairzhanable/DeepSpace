...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtTerrainOcean : SgtTerrain
	{
		...
		{
			var gameObject = SgtHelper.CreateGameObject("Terrain Ocean", layer, parent, localPosition, localRotation, localScale);
...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtTerrainOcean_Editor : SgtTerrain_Editor
	{
		...
		[MenuItem(SgtHelper.GameObjectMenuPrefix + "Terrain Ocean", false, 10)]
